...
/**
 * Part 1 Problem: You are given a text with some words used repeatedly. Write a function to find the first word that has nearest repetition.
 * "He has to conceal what he would most wish to make public, and make public what he would most wish to conceal. I like the word make so much that I use word make to keep on making things. ” -  Churchill
 * Repeated words are “he”, “conceal”, “what”, “would”, “most”, “wish”, “to”, “make”, “public"
 * output = "Word is ‘make' and shortest distance is 2”
 * <p>
 * Part 2:
 * Write an API that allows clients to keep calling a next method to return the next such word
 */
